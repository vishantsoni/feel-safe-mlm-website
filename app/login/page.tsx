...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setError('');
    try {
      const res = await serverCallFuction('POST','api/ecom/auth/login', { email, password });      
      if(res.status){        
              ...
              <div className="card shadow-lg border-0">
                <div className="card-body p-5">
                  <div className="text-center mb-5">
                    ...
                    <p className="text-muted">Sign in to your distributor account</p>
                  </div>
                  ...
                  <form onSubmit={handleLogin}>
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-4">
                      ...
                      <Link href="/forgot-password" className="text-decoration-none text-muted">
                        Forgot Password?
                      </Link>
                    </div>
                    <button 
                  ...
                  <div className="text-center mt-4">
                    ...
                    <Link href="/register" className="btn btn-outline-primary px-4 py-2 fw-semibold">
                      Sign Up Now
                    </Link>
                  </div>
