              ...
              <div className="row">
                ...
                <div className="col-md-10">
                  <div className="card-body p-0">
                    <h5>Local Store Pickup</h5>
                    <p className="card-text">Dispatched by your local distributor or our warehouse.</p>
                  </div>
                </div>
              </div>
              </div>
            ...
            <div className="card mb-3 border-0">
              <div className="row">
                ...
                <div className="col-md-10">
                  <div className="card-body p-0">
                    <h5>100% Secure</h5>
                    <p className="card-text">Encrypted transactions for your peace of mind.</p>
                  </div>
                </div>
              </div>
              </div>
              ...
              <div className="row">
                ...
                <div className="col-md-10">
                  <div className="card-body p-0">
                    ...
                    <p className="card-text">Lab-tested, high-absorbency hygiene essentials..</p>
                  </div>
                </div>
              </div>
              </div>
          ...
          <div className="col">
            <div className="card mb-3 border-0">
              <div className="row">
                ...
                <div className="col-md-10">
                  <div className="card-body p-0">
                    <h5>Matrix Rewards</h5>
                    <p className="card-text">Save more with our 10-level forced matrix plan.</p>
                  </div>
                </div>
              </div>
              </div>
