      ...
      <section className="py-5">
        <div className="container-fluid">
          <div className="row row-cols-1 row-cols-sm-2 row-cols-lg-4">
            <div className="col mb-5 mb-md-0" data-aos="zoom-in-up">
                ...
                <div className="row">
                  ...
                  <div className="col-md-10">
                    <div className="card-body p-0">
                      <h5>Fast & Reliable Pan-India Delivery</h5>
                      <p className="card-text">With a robust network of regional warehouses and local distributors, we ensure your orders reach you in record time. Our logistics system is designed to support our Sakhis across every pin code in India, providing a seamless supply chain experience.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col mb-5 mb-md-0" data-aos="zoom-in-up">
              <div className="card mb-3 border-0">
                <div className="row">
                  ...
                  <div className="col-md-10">
                    <div className="card-body p-0">
                      <h5>100%  Secure & Transparent Payments</h5>
                      <p className="card-text">Your financial security is our top priority. Powered by industry-leading payment gateways, we offer bank-grade encryption for every transaction. Whether it's a payout or a purchase, you can trust our 100% transparent and secure digital ecosystem.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col mb-5 mb-md-0" data-aos="zoom-in-up">
              <div className="card mb-3 border-0">
                <div className="row">
                  ...
                  <div className="col-md-10">
                    <div className="card-body p-0">
                      <h5>BIS Standard  Certified Premium Quality</h5>
                      <p className="card-text">Every 'Feel' product undergoes rigorous testing to meet the highest hygiene standards. Certified by BIS (Bureau of Indian Standards) and manufactured in ISO & GMP facilities, our sanitary pads offer superior absorbency and skin-friendly protection.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col mb-5 mb-md-0" data-aos="zoom-in-up">
              <div className="card mb-3 border-0">
                <div className="row">
                  ...
                  <div className="col-md-10">
                    <div className="card-body p-0">
                      <h5>Social Impact and Women Empowerment</h5>
                      <p className="card-text">Feel Safe Private Limited is not just a business, but a movement. Our mission is to empower 1 Lakh women across India to become financially independent leaders (Sanchalak Sakhis) to build a healthy and prosperous nation. </p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="card mb-3 border-0">
              <div className="row">
                ...
                <div className="col-md-10">
                  <div className="card-body p-0">
                    <h5>Daily Bonuses/ Offers</h5>
                    <p className="card-text">Fresh deals and MLM commissions updated daily.</p>
                  </div>
                </div>
              </div>
              </div>
