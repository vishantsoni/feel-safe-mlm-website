                        ...
                        <div className="mb-5">
                            ...
                            <div className="d-flex align-items-start mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted mb-0">+91 {contact_data?.phone}</p>
                                    <small className="text-brand-green fw-medium">
                                        {contact_data?.time || 'N/A'}
                                    </small>
                                </div>
                            </div>
                            ...
                            <div className="d-flex align-items-start mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted mb-0">{contact_data?.email_1}</p>
                                    <p className="text-muted mb-0">{contact_data?.email_2}</p>
                                </div>
                            </div>
